...
int count_points_for_field(int x,int y){ //Returns points for single field
	int total_points=0,a=0,b=0,c=0,d=0,e=0;	
...
int main(int argc,char *argv[]){	
	...
	printf("NIE JEST COSTAM GOWNO JEBAC POLICJE\n");
	return 0;
}
